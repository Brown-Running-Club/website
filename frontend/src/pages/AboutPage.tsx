    ...
    return (
      <>
        ...
        <PageBody>
          <WideContainer>
            <Card>
              <p style={styles.infoText}>We’re the place for competitive and recreational running at Brown University. Whether you’re an undergrad, grad student, faculty, or staff member, we encourage you to join us for a run. We welcome runners of all levels! For those interested in running competitively, we compete in cross country races, indoor and outdoor track meets, and road races. If you want to check us out, stop by for a run! Additionally, you can find out more by looking around here, joining our Facebook group or shooting us an email at run@brown.edu.</p>
          ...
          <NarrowContainer>
            <Card title="More Info" centeredTitle>
              <Button leftAlign text="Recent Running Club announcements ➞" />
              <Button leftAlign text="Running Club FAQ ➞" />
              <Button leftAlign text="Learn about the competitive team ➞" />
              <Button
                leftAlign

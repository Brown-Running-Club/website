...
const men_xc = [
  ...
  const men_itrack = [
    ...
    createData('4x400m', 'I. Oda-Bayliss, E. Laidlaw, M. Heller, M. Vigilante', '3:43.3', "2019"),
    createData('4x800m', 'J. Eveleth, T. McClure, M. Heller, E. Laidlaw', '8:14.60hc', "2020"),
    createData('DMR', 'A. Janik, Z. Harris, M. Vigilante, E. Laidlaw', '10:57.49', "2019"),
  ...
  const women_itrack = [
    ...
    createData('4x400m', 'R. Johnson, J. McClellan, C. Nelson, G. Dorantes', '5:06.61hc', "2020"),
    createData('4x800m', 'M. Driscoll, V. Sackett, G. Dorantes, C. Nelson', '11:00.05hc', "2020"),
    createData('DMR', 'M. Driscoll, J. McClellan, J. Jiang, K. Chu', '13:50.07', "2019"),
  ...
  const men_otrack = [
    ...
    createData('4x100m', 'T. Houchens, A. Janik, M. Vigilante, C. Wenzel', '52.36', "2019"),
    createData('4x400m', 'I. Oda-Bayliss, E. Laidlaw, K. Abeywardane, M. Vigilante', '3:45.33', "2019"),
    createData('4x800m', 'E. Laidlaw, M. Hornbuckle, I. Oda-Bayliss, M. Heller', '8:30.41', "2019"),
  ];
  ...
  const women_otrack = [
    ...
    createData('4x100m', 'M. Driscoll, J. Jiang, J. McClellan, R. Johnson', '1:08.12h', "2019"),
    createData('4x400m', 'J. McClellan, M. Driscoll, R. Johnson, J. Jiang ', '5:01.63', "2019"),
    createData('4x800m', 'C. Ribet, J. Jiang, M. Driscoll, J. McClellan', '11:47.60', "2019"),
  ];
...
export default function BasicTable(props: React.PropsWithChildren<RecordProps>) {
  ...
  return (
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow >
          <TableCell className={classes.header} align="left">Event</TableCell>
            <TableCell className={classes.header} align="left">Name</TableCell>
            <TableCell className={classes.header} align="left">Time</TableCell>
            <TableCell className={classes.header} align="left">Year</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.year}>
              ...
              <TableCell className={classes.row} align="left">{row.event}</TableCell>
              <TableCell className={classes.row} align="left">{row.name}</TableCell>
              <TableCell className={classes.row} align="left">{row.time}</TableCell>
              <TableCell className={classes.row} align="left">{row.year}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>

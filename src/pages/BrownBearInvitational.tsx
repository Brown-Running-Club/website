...
import Photo1 from "../assets/images/brown-bear-invitational/course-photo-1.jpg";
import Photo2 from "../assets/images/brown-bear-invitational/course-photo-2.jpg";
import Photo3 from "../assets/images/brown-bear-invitational/course-photo-3.jpg";

export default class BrownBearInvitational extends Component {
  render() {
    return (
      <div>
        <NavigationBar />
          ...
          <WideContainer>
            <Card>
              <p style={styles.welcomeText}>
                ...
                <br />
                <b>Location:</b> Highland Park, 104 Mechanic Street, Attleboro,
                MA 02703 <br />
                ...
                <b>Entry Fee:</b> $15/athlete for NIRCA clubs, max $250/gender
                for teams. $20/open athletes. $30/day of.
                <br />
                <br />
                ...
                each age group. Plaques to top three men and women NIRCA teams
                and first men and women non-NIRCA teams. The awards ceremony
                will begin at 2:00 pm.
                <br />
                <br />
                <b>Results:</b> Available on DirectAthletics, clubrunning.org,
                and on the meet website.
                <br />
                <br />
                <b>Payment Options:</b>
                <ul style={{ listStyleType: "none" }}>
                  ...
                  <li>
                    ...
                    follow link or send to @BrownRunningClub. Include full name
                    in description
                  </li>
                  <li>

        ...
        <PageBody>
          <WideContainer>
            ...
            <Card title="Joining the team">
              <p style={styles.bodyText}>The first step to competing with BRC is filling out our competitive team interest form (coming soon).</p>
              ...
              <Button text="Fill out the club sports waiver ➞" link="https://brownrec.com/sports/2018/8/14/club-sports-registrations-offerings.aspx" ></Button>
